    ...
    <nav class="top-nav" style="position: fixed; top: 0; left: 0; right: 0; z-index: 1000; padding: 0 5%; display: flex; justify-content: space-between; align-items: center; background: var(--header-gradient); border-bottom: 1px solid #e2e8f0; height: var(--header-height);">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div class="site-branding">
                    <h2 style="margin: 0; font-size: 1.1rem; color: #1e293b; text-transform: uppercase; font-weight: 800; letter-spacing: -0.5px; line-height: 1;">EmCa Technologies</h2>
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: nowrap;">
                ...
                <form action="{{ route('logout') }}" method="POST" style="margin:0;">
                    @csrf
                    <button type="submit" style="background: #f1f5f9; border: none; color: #ef4444; width: 40px; height: 40px; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background 0.2s;" title="Logout">
    ...
    <div class="admin-layout" style="margin-top: var(--header-height);">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer" style="padding: 2rem; border-top: 1px solid #FFF5F5; margin-top: auto;">
                <p style="font-size: 0.8rem; color: var(--corporate-red); font-weight: 700; margin-bottom: 8px; display: flex; align-items: center; gap: 8px;"><i class="fa-solid fa-circle" style="font-size: 0.5rem;"></i> System Online</p>
            </div>
        </aside>
