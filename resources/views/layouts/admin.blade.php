...
<body>
    ...
    <nav class="top-nav" style="position: fixed; top: 0; left: 0; right: 0; z-index: 1000; padding: 0 5%; display: flex; justify-content: space-between; align-items: center; background: var(--header-gradient); border-bottom: 1px solid #e2e8f0; height: var(--header-height);">
            <div style="display: flex; align-items: center; gap: 1rem;">
                <button onclick="toggleSidebar()" style="display: none; background: white; border: 1px solid #e2e8f0; color: #475569; width: 44px; height: 44px; border-radius: 8px; cursor: pointer; align-items: center; justify-content: center; font-size: 1.25rem;" class="mobile-menu-toggle">
                ...
                <div class="site-branding">
                    <h2 style="margin: 0; font-size: 1.1rem; color: #1e293b; text-transform: uppercase; font-weight: 800; letter-spacing: -0.5px; line-height: 1;">EmCa Techonologies</h2>
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: nowrap;">
                <!-- Notification Bell -->
                @php $unreadCount = \App\Models\Registration::where('is_read', false)->count(); @endphp
                <a href="{{ route('admin.attendees.index') }}" style="position: relative; background: #f1f5f9; color: #475569; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; text-decoration: none; transition: all 0.2s;" title="New Registrations">
                ...
                <div style="text-align: right; display: flex; flex-direction: column; justify-content: center; margin-right: 5px;" class="admin-user-info">
                    <p style="margin: 0; font-weight: 800; font-size: 0.8rem; color: #1e293b; line-height: 1;">{{ auth()->user()->name }}</p>
                    <p style="margin: 0; font-size: 0.65rem; color: var(--corporate-red); font-weight: 800; text-transform: uppercase;">Portal Administrator</p>
                </div>
        ...
        <aside class="sidebar">
            ...
            <div class="mobile-sidebar-header">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <h2 style="margin: 0; font-size: 1rem; color: #1e293b; font-weight: 800; text-transform: uppercase;">Menu</h2>
                </div>
    ...
    <footer style="background: #FFFFFF; border-top: 3px solid var(--corporate-red); padding: 30px 20px; color: #64748b; text-align: center;">
        ...
        <div style="font-size: 0.7rem; color: var(--corporate-red); font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px;">
